...
import com.flow.booktrade.config.audit.AuditEventConverter;
import com.flow.booktrade.domain.PersistentAuditEvent;
import com.flow.booktrade.repository.PersistenceAuditEventRepository;
import com.flow.booktrade.service.AuditEventService;
...
@SpringBootTest(classes = BooktradeApp.class)
@Transactional
